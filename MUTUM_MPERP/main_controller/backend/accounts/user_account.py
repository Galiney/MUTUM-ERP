...
class User_account:
    ...
    def to_dict(self) -> dict:
        """
        Converte a instância de User_account para um dicionário serializável.
        """
        return {
            'creator': self.__creator.get_username() if isinstance(self.__creator, User_account) else self,
            ...
            'addresses': [address.get_custom_data() for address in self.__addresses],
            'time_of_creation': self.__time_of_creation.isoformat(),
            'birthday': self.__birthday.isoformat() if self.__birthday else None,
            'username': self.__username,
            'enterprises': [enterprise.to_dict() for enterprise in self.__enterprises],
            'permissions': self.__permissions.to_dict() if hasattr(self.__permissions, 'to_dict') else None
        }
